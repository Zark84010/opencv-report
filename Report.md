...
**Code Link:** https://github.com/Zark84010/opencv-report/blob/master/play_game.py

My code, is mostly similar to the code (https://github.com/jatinparab98/HandDino/blob/master/camera.py) given in the blog post (https://medium.com/@sulphurgfx/playing-chromes-dinosaur-game-using-computer-vision-105da2f3114f), but I made it more clear.
